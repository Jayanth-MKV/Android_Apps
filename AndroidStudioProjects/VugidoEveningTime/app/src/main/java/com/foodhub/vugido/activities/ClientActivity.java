...
import com.foodhub.vugido.models.clients_menu.DATA;
...
public class ClientActivity  extends AppCompatActivity implements ProductListRecyclerViewAdapter.CLICKED_ADD,MenuCategoryAdapter.MenuCatClicked, SwipeRefreshLayout.OnRefreshListener {
