...
import com.foodhub.vugido.models.shipping.DATA;
import com.foodhub.vugido.models.shipping.Response;
...
//                new MyPreferences(getApplicationContext()).setLocLan(String.valueOf(LONGITUDE));
//                new MyPreferences(getApplicationContext()).setLocLat(String.valueOf(LATITUDE));
//                new MyPreferences(getApplicationContext()).setUserPrimaryAddress(ADDRESS);
//                new MyPreferences(getApplicationContext()).setLM(lm.getText().toString());
//                new MyPreferences(getApplicationContext()).setDNO(dno.getText().toString());
