...
//    private List<RectangularMediumViewModel> rectangularMediumViewModelList;
    private List<PRODUCTSMENUItem> squareMediumModelList;

    public List<SECItem> getCategoriesItemList() {
        return categoriesItemList;
    }

    public void setCategoriesItemList(List<SECItem> categoriesItemList) {
        this.categoriesItemList = categoriesItemList;
    }

    private List<SECItem> categoriesItemList;
...
//        return homePageMainModel;
//    }
    public static HomePageMainModel createSquareMediumViewModelList(List<SECItem> categoriesItemList,int type, List<PRODUCTSMENUItem> squareMediumModelList, String title, int hid, String BG_COLOR, String TITLE_COLOR){
        HomePageMainModel homePageMainModel=new HomePageMainModel();
...
//    }
    ...
    public List<PRODUCTSMENUItem> getSquareMediumModelList() {
        return squareMediumModelList;
    }

    public void setSquareMediumModelList(List<PRODUCTSMENUItem> squareMediumModelList) {
