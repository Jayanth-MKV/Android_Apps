...
import vugido.foodhub.ap.sklm.hungrybirds.models.user.Response;
import vugido.foodhub.ap.sklm.hungrybirds.models.user.USER;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
      ...
      //  initSmsRetriever();
        ...
        if(getIntent().getIntExtra("T",0)==0){
            ...
            firebaseAuth(getIntent().getStringExtra("N"),getIntent().getStringExtra("M"));

        }else{
            //login
            firebaseAuth(null,getIntent().getStringExtra("M"));
...
private void firebaseAuth(String name, String phone){
