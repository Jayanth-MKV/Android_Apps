package vugido.foodhub.ap.sklm.hungrybirds.adapters.cart;
...
//        }else {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        if(ProductItem.getOFFER()>0){
            ...
            // offer exists..
            holder.ProductPrice.setText(String.format(Locale.getDefault(),"Rs.%d/-", Offer(ProductItem.getPRICE()*count.get(position),ProductItem.getOFFER())));
            holder.StrikedPrice.setText(String.format(Locale.getDefault(),"Rs.%d/-", ProductItem.getPRICE()*count.get(position)));
            ...
            holder.ProductPrice.setText(String.format(Locale.getDefault(),"Rs.%d/-", ProductItem.getPRICE()*count.get(position)));
        }
