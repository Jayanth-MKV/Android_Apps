package vugido.foodhub.ap.sklm.hungrybirds.fragments.bottom_sheet;
...
import vugido.foodhub.ap.sklm.hungrybirds.activities.ProfileActivity;
import vugido.foodhub.ap.sklm.hungrybirds.activities.TermsAndConditionsPrivacyPolicy;
import vugido.foodhub.ap.sklm.hungrybirds.adapters.homepage.HomeMenuBottomSheetAdapter;
...
public class HomeOptionsBottomSheet extends BottomSheetDialogFragment implements View.OnClickListener, HomeMenuBottomSheetAdapter.OPTION_SELECTED {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        homeMenuBottomModelList.add(new HomeMenuBottomModel(R.mipmap.logo_blueearth,"About Us",9));
        homeMenuBottomModelList.add(new HomeMenuBottomModel(R.drawable.feed_back,"Email FeedBack",10));
    ...
    public void optionSelected(int id) {
        ...
        switch (id){
            ...
            case 3:
                //whatsapp us
                try {
                    String text = "Dear BlueEarth Restaurant Team:\n";// Replace with your message.
            ...
            case 4:
                ...
                callIntent.setData(Uri.parse("tel:919346834541"));
            ...
            case 5:
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "\nInstall App BlueEarth Restaurant\n");
