...
import com.vugido.foodhub.hungrybirdsadmin.activities.OrderedItemsActivity;
import com.vugido.foodhub.hungrybirdsadmin.models.orders.AO.DATAItem;
...
public class MyPendingOrdersAdapter extends RecyclerView.Adapter<MyPendingOrdersAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
       ...
       // holder.time.setText(String.format("Deliver Time : %s", dataItem.getTIME()));
        holder.address_info.setText(String.format("Address : %s %s %s ",dataItem.getADDRESS(), dataItem.getNOTE(),  dataItem.getACTIVEPHONE()));
        ...
        holder.ButtonUserInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String number = "tel:"+dataItem.getACTIVEPHONE();
