...
//        return homePageMainModel;
//    }
    public static HomePageMainModel createSquareMediumViewModelList(int type, List<PRODUCTSMENUItem> squareMediumModelList, String title, int hid, String BG_COLOR, String TITLE_COLOR){
        HomePageMainModel homePageMainModel=new HomePageMainModel();
