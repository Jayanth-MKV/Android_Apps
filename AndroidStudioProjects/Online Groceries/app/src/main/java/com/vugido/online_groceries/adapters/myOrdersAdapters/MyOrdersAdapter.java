package com.vugido.online_groceries.adapters.myOrdersAdapters;
...
import com.vugido.online_groceries.activities.TrackingActivity;
...
public class MyOrdersAdapter extends RecyclerView.Adapter<MyOrdersAdapter.MyViewHolder> {
    ...
    public MyOrdersAdapter(Context context,
                           List<com.vugido.online_groceries.models.orders.all_orders.ORDERSItem>
                                   dataItemList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(dataItem.getSTATUS()==1){
            ...
            holder.orderStatusText.setText("Cancelled");
        else if (dataItem.getSTATUS()==6)
            holder.orderStatusText.setText("Failed");
