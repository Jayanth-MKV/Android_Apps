...
import com.vugido.online_groceries.activities.AllProductsActivity;
...
public class CategoryRecyclerViewAdapter extends RecyclerView.Adapter<CategoryRecyclerViewAdapter.MyViewHolder> {
    ...
    private List<CATEGORIESItem> CategoryModelList;
    private Context context;
    private String des,name;
    private Activity activity;


    public CategoryRecyclerViewAdapter(List<CATEGORIESItem> CategoryModelList, Context context, String des, String name){
