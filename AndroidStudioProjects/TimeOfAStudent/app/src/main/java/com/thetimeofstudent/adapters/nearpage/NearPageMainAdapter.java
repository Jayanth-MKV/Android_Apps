package com.thetimeofstudent.adapters.nearpage;
...
import com.thetimeofstudent.adapters.homepage.SquareMediumRecyclerViewAdapter;
import com.thetimeofstudent.designs.Space;
import com.thetimeofstudent.models.MAIN_MODEL.HomePageMainModel;

import java.util.List;

import static com.thetimeofstudent.models.MAIN_MODEL.HomePageMainModel.SQUARE_MEDIUM_VIEW;
...
//            CircularRecycledViewPool,ChipPool,MediumRectPool,SquareMiniPool,ListPool;
    ...
    public NearPageMainAdapter(List<HomePageMainModel> homePageMainModelList, Context context) {
