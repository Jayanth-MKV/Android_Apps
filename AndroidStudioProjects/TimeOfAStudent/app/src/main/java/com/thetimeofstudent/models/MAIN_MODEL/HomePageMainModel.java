...
//    private List<RectangularMediumViewModel> rectangularMediumViewModelList;
    private List<HOMEPRODUCTSItem> squareMediumModelList;
...
//        return homePageMainModel;
//    }
    public static HomePageMainModel createSquareMediumViewModelList(List<SECTIONSItem> categoriesItemList,int type, List<HOMEPRODUCTSItem> squareMediumModelList, String title, int hid, String BG_COLOR, String TITLE_COLOR){
        HomePageMainModel homePageMainModel=new HomePageMainModel();
...
//    }
    ...
    public List<HOMEPRODUCTSItem> getSquareMediumModelList() {
        return squareMediumModelList;
    }

    public void setSquareMediumModelList(List<HOMEPRODUCTSItem> squareMediumModelList) {
