package com.vugido.brain_cord.app;
...
public class MyPreferences {
    ...
    private static final String PREFERENCES_NAME = "VUGIDO_BRAINCORD";
    ...
    public String getAnswerS(){
        ...
        return sharedPreferences.getString("AnsS",null);
    }

    public void setAnswer(String s){

        editor.putString("AnsS",s);
        editor.apply();
