...
import com.vugido.vugidoupdate.dialogs.BottomSheetDialog;
import com.vugido.vugidoupdate.dialogs.MyBottomSheetLoader;
import com.vugido.vugidoupdate.dialogs.MyDialogLoader;
import com.vugido.vugidoupdate.fragments.login_fragments.LoginFragment;
import com.vugido.vugidoupdate.fragments.login_fragments.SignUpFragment;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener , SignUpFragment.LoginFragmentInterface, LoginFragment.SignUpFragmentInterface ,
    ...
    private void loadDefaultSignUpFragment() {
        ...
        fragmentTransaction.add(R.id.login_fragment_container,fragment,"LOGIN");
