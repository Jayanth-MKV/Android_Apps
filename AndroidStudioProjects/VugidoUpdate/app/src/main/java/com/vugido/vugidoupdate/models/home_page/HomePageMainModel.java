...
public class HomePageMainModel {
    ...
    private List<SquareMediumModel> squareMediumModelList;
...
/// Factory Methods...
    ...
    public static HomePageMainModel createSquareMediumViewModelList(int type,List<SquareMediumModel> squareMediumModelList,String title,int hid,String BG_COLOR,String TITLE_COLOR){
        HomePageMainModel homePageMainModel=new HomePageMainModel();
    ...
    public List<SquareMediumModel> getSquareMediumModelList() {
        return squareMediumModelList;
    }

    public void setSquareMediumModelList(List<SquareMediumModel> squareMediumModelList) {
