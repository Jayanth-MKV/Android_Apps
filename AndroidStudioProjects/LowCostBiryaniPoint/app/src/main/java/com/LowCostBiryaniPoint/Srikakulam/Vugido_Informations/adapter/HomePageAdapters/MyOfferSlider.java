package com.LowCostBiryaniPoint.Srikakulam.Vugido_Informations.adapter.HomePageAdapters;
...
import com.LowCostBiryaniPoint.Srikakulam.Vugido_Informations.activities.AllProductsActivity;
...
public class MyOfferSlider extends PagerAdapter {
    ...
    private List<HIGHTLIGHTItem> screenItemList;
    private Context context;
    private FragmentActivity fragmentActivity;


    public MyOfferSlider(List<HIGHTLIGHTItem> screenItemList, Context context) {
