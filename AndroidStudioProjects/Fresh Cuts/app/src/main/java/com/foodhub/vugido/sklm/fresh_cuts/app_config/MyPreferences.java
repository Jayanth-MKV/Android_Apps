package com.foodhub.vugido.sklm.fresh_cuts.app_config;
...
public class MyPreferences {
    ...
    public void setOnGoing(boolean s){

        editor.putBoolean("ON_GOING",s);
        editor.apply();

    }
    public boolean isOnGoing(){

        return sharedPreferences.getBoolean("ON_GOING",false);
    }
