...
import com.foodhub.vugido.sklm.fresh_cuts.adapters.intro.IntroViewPagerAdapter;
...
public class AppIntroduction extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mList.add(new ScreenItem("Welcome To","Fresh Cuts",R.raw.delivery_boy));
        mList.add(new ScreenItem("Fast Delivery","As per your timings",R.raw.delivery_boy));
...
*/
        ...
        btnGetStarted.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               Intent intent=new Intent(AppIntroduction.this,UserRegisteration.class);
