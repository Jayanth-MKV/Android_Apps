package com.foodhub.vugido.sklm.fresh_cuts.fragments.bottom_sheet;
...
import com.foodhub.vugido.sklm.fresh_cuts.activities.TermsAndConditionsPrivacyPolicy;
import com.foodhub.vugido.sklm.fresh_cuts.adapters.homepage.HomeMenuBottomSheetAdapter;
import com.foodhub.vugido.sklm.fresh_cuts.app_config.MyPreferences;
import com.foodhub.vugido.sklm.fresh_cuts.models.BOTTOM_HOME_MODEL.HomeMenuBottomModel;
...
public class HomeOptionsBottomSheet extends BottomSheetDialogFragment implements View.OnClickListener, HomeMenuBottomSheetAdapter.OPTION_SELECTED {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        homeMenuBottomModelList.add(new HomeMenuBottomModel(R.drawable.person,"Profile",1));
        ...
        homeMenuBottomModelList.add(new HomeMenuBottomModel(R.drawable.call,"Call Helpline",4));
        ...
        homeMenuBottomModelList.add(new HomeMenuBottomModel(R.drawable.tc,"Terms & Conditions",7));
        homeMenuBottomModelList.add(new HomeMenuBottomModel(R.drawable.pp,"Privacy Policy",8));
        homeMenuBottomModelList.add(new HomeMenuBottomModel(R.drawable.hbicon,"About Us",9));
    ...
    public void optionSelected(int id) {
        ...
        switch (id){
            ...
            case 3:
                //whatsapp us
                try {
                    String text = "Dear Hungry Birds Restaurant Team:\n";// Replace with your message.

                    String toNumber = "919133278279"; // Replace with mobile phone number without +Sign or leading zeros, but with country code
            ...
            case 4:
                ...
                callIntent.setData(Uri.parse("tel:9133278279"));
            ...
            case 5:
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "\nInstall App Hungry Birds Restaurant\n");
