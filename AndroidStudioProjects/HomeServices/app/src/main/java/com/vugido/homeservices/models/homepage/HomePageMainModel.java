...
//    private List<RectangularMediumViewModel> rectangularMediumViewModelList;
    private List<SERVICEPRODUCTSItem> squareMediumModelList;

    public List<SERVICECATEGORIESItem> getCategoriesItemList() {
        return categoriesItemList;
    }

    public void setCategoriesItemList(List<SERVICECATEGORIESItem> categoriesItemList) {
        this.categoriesItemList = categoriesItemList;
    }

    private List<SERVICECATEGORIESItem> categoriesItemList;
...
//        return homePageMainModel;
//    }
    public static HomePageMainModel createSquareMediumViewModelList(List<SERVICECATEGORIESItem> categoriesItemList, int type, List<SERVICEPRODUCTSItem> squareMediumModelList, String title, int hid, String BG_COLOR, String TITLE_COLOR){
HomePageMainModel homePageMainModel=new HomePageMainModel();
...
//    }
    ...
    public List<SERVICEPRODUCTSItem> getSquareMediumModelList() {
        return squareMediumModelList;
    }

    public void setSquareMediumModelList(List<SERVICEPRODUCTSItem> squareMediumModelList) {
