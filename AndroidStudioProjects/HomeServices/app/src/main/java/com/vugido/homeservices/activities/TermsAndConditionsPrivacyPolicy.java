...
public class TermsAndConditionsPrivacyPolicy extends AppCompatActivity {
    ...
    private String TC_URL="http://homeservices.vugido.com/terms_and_conditions.html";
    private String PP_URL="http://homeservices.vugido.com/privacy_policy.html";
    private String ABOUT_US_URL="http://homeservices.vugido.com/";
