...
import com.vugido.homeservices.design.Space;
import com.vugido.homeservices.models.near_page.NearPageMainModel;

import java.util.List;

import static com.vugido.homeservices.models.near_page.NearPageMainModel.SQUARE_MEDIUM_VIEW;


public class NearPageMainAdapter extends Adapter {
...
//            CircularRecycledViewPool,ChipPool,MediumRectPool,SquareMiniPool,ListPool;
    ...
    public NearPageMainAdapter(List<NearPageMainModel> homePageMainModelList, Context context) {
...
//                return new MySliderView(view);
            case SQUARE_MEDIUM_VIEW:
                view= LayoutInflater.from(context).inflate(R.layout.nearb_recycler_view,parent,false);
...
//                return mySquareMiniView;
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        NearPageMainModel homePageMainModel=homePageMainModelList.get(position);
...
//                });
               ...
               // ((MySquareMedium)holder).SquareMediumRecyclerView.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.VERTICAL,false));
                ...
                NearMediumRecyclerViewAdapter squareMediumRecyclerViewAdapter=new NearMediumRecyclerViewAdapter(homePageMainModel.getSquareMediumModelList(),context,homePageMainModel.getCategoriesItemList());
