...
import com.vugidovugidoclientpanel.adapter.AllProductsRecyclerViewAdapter;
import com.vugidovugidoclientpanel.app_congif.MyPreferences;
import com.vugidovugidoclientpanel.models.All_Products.DATA;
import com.vugidovugidoclientpanel.models.All_Products.ITEMSItem;
import com.vugidovugidoclientpanel.models.All_Products.MENUItem;
import com.vugidovugidoclientpanel.models.All_Products.Response;
...
public class AllProducts extends AppCompatActivity implements AllProductsRecyclerViewAdapter.Updater {
    ...
    private void initDelete(final int pid) {
        ...
        Call<com.vugidovugidoclientpanel.models.Updater.delete.Response> call=RetrofitBuilder.getInstance().getRetrofit().delete(map);

        call.enqueue(new Callback<com.vugidovugidoclientpanel.models.Updater.delete.Response>() {
            @Override
            public void onResponse(@NonNull Call<com.vugidovugidoclientpanel.models.Updater.delete.Response> call,@NonNull retrofit2.Response<com.vugidovugidoclientpanel.models.Updater.delete.Response> response) {
                progress.setVisibility(View.GONE);
                progress.cancelAnimation();
                if(response.isSuccessful()){
            ...
            @Override
            public void onFailure(@NonNull Call<com.vugidovugidoclientpanel.models.Updater.delete.Response> call,@NonNull Throwable t) {
                progress.setVisibility(View.GONE);
                progress.cancelAnimation();
                showDialogStatus(false,"Deleted Successfully","Error!! Try Again..");
            }
