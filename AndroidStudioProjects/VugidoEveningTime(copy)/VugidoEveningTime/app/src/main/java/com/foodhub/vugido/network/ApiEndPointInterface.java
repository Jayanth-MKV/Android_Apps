...
public interface ApiEndPointInterface {
    ...
    @FormUrlEncoded
    @POST("/ANDROID_APP/GET_COIN_TRANSACTIONS.php")
    Call<com.foodhub.vugido.models.coins.Response>getCoinsTransactions(@FieldMap Map<String, Object> queryMap);


    @FormUrlEncoded
    @POST("/ANDROID_APP/GET_SCRATCH_CARD_INFO.php")
    Call<com.foodhub.vugido.models.scratch_cards.Response>getScratchCardInfo(@FieldMap Map<String, Object> queryMap);
    ...
    Call<com.foodhub.vugido.models.cart.get_cart.Response>fetchCartItems(@FieldMap Map<String, Object> queryMap);
    ...
    Call<com.foodhub.vugido.models.product.client_products.Response> cid_menu(@FieldMap Map<String, Object> queryMap);
    ...
    @FormUrlEncoded
    @POST("/ANDROID_APP/TO_CART.php")
    Call<com.foodhub.vugido.models.cart.add_to_cart.Response> toCart(@FieldMap Map<String, Object> queryMap);



    @FormUrlEncoded
    @POST("/ANDROID_APP/DELETE_CART_PRODUCT.php")
    Call<com.foodhub.vugido.models.cart.cart_delete.Response> deleteFromCart(@FieldMap Map<String, Object> queryMap);
