package com.foodhub.vugido.fragments.bottom_sheet;
...
import com.foodhub.vugido.activities.ProfileActivity;
import com.foodhub.vugido.activities.TermsAndConditionsPrivacyPolicy;
import com.foodhub.vugido.adapters.homepage.HomeMenuBottomSheetAdapter;
import com.foodhub.vugido.models.BOTTOM_HOME_MODEL.HomeMenuBottomModel;
...
public class HomeOptionsBottomSheet extends BottomSheetDialogFragment implements View.OnClickListener, HomeMenuBottomSheetAdapter.OPTION_SELECTED {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        homeMenuBottomModelList.add(new HomeMenuBottomModel(R.drawable.link,"Link your food business",2));
    ...
    public void optionSelected(int id) {
        ...
        switch (id){
            ...
            case 2:
                try {
                    String text = "Dear Vugido Food-Hub Team: I wanna link my food business with you ..\n";// Replace with your message.
            ...
            case 5:
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "\nInstall App Vugido Food-Hub\n");
                intent.putExtra(Intent.EXTRA_TEXT, "\nInstall App Vugido Food-Hub \nOrder " +
                        "Fruits,Dry-Fruits,Foods.. etc  Online\nClick On Link To Install" + "\n\n" + "https://play.google.com/store/apps/details?id=" + context.getPackageName());
