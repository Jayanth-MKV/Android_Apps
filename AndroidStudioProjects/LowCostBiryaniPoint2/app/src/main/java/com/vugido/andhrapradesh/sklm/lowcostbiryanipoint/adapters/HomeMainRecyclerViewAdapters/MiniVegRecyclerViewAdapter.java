...
public class MiniVegRecyclerViewAdapter extends RecyclerView.Adapter<MiniVegRecyclerViewAdapter.MyViewHolder> {
    private List<VEGETABLESItem> vegetablesItemList;
    private Context context;
    private FragmentActivity fragmentActivity;

    public MiniVegRecyclerViewAdapter(List<VEGETABLESItem> vegetablesItemList, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final VEGETABLESItem ProductItem=vegetablesItemList.get(position);
        ...
        if(ProductItem.getISGRAMSET()==1){
            ...
            holder.ProductQuantity.setText(BaseProduct.getGramQuantity(ProductItem.getQUANTITY(),ProductItem.getDESCRIPTION()));
    ...
    private void callProductDetailsActivity(VEGETABLESItem ProductItem) {
    ...
    public int getItemCount() {
        return vegetablesItemList.size();
    }
