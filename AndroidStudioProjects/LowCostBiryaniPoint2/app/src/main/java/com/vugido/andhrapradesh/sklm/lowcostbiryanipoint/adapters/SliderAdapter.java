...
import com.foodhub.vugido.models.HomeFragmentHomeModel.OFFERSItem;
...
public class SliderAdapter extends PagerAdapter {
    ...
    private List<OFFERSItem> sliderModelList;
    private Context context;

    public SliderAdapter(List<OFFERSItem> sliderModelList,Context context) {
