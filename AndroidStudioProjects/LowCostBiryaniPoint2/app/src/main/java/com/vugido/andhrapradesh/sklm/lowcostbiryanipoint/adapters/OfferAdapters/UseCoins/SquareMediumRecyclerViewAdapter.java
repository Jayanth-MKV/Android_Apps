...
import com.foodhub.vugido.models.updated.all_products_of_category.DATAItem;
...
public class SquareMediumRecyclerViewAdapter extends RecyclerView.Adapter<SquareMediumRecyclerViewAdapter.MyViewHolder> {
    ...
    Context context;
    List<COINSSPENDINGItem> coinsspendingItemList;
    private CoinProductsToCart coinProductsToCart;
    private FragmentActivity fragmentActivity;


    public SquareMediumRecyclerViewAdapter(Context context, List<COINSSPENDINGItem> coinsspendingItemList,CoinProductsToCart coinProductsToCart) {
        this.context = context;
        this.coinsspendingItemList=coinsspendingItemList;
        this.coinProductsToCart= coinProductsToCart;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        COINSSPENDINGItem coinsspendingItem=coinsspendingItemList.get(position);
    ...
    private void callProductDetailsActivity(COINSSPENDINGItem ProductItem) {
    ...
    public interface CoinProductsToCart{
        void addCoinProductsCart(int cid, int pid, int q);
    }
}
