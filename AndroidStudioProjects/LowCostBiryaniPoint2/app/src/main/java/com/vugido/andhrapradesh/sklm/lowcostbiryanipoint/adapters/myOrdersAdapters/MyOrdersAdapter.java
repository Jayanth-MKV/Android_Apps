package com.vugido.andhrapradesh.sklm.lowcostbiryanipoint.adapters.myOrdersAdapters;
...
public class MyOrdersAdapter extends RecyclerView.Adapter<MyOrdersAdapter.MyViewHolder> {
    ...
    public MyOrdersAdapter(Context context, List<DATAItem> dataItemList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.recyclerView.setAdapter(new OrderedItemsAdapter(dataItem.getIMAGESARRAY(),context));
        ...
        if(dataItem.getSTATUS()==0){
            ...
            holder.orderStatusText.setText("Packed");
        }else if(dataItem.getSTATUS()==2){
            holder.orderStatusText.setText("Dispatched");
        }else if(dataItem.getSTATUS()==3){
            holder.orderStatusText.setText("Processing");
        }else {
