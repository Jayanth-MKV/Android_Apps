package com.vugido.andhrapradesh.sklm.lowcostbiryanipoint.adapters.FreeProductsAdapter;
...
public class FreeProductsAdapter extends RecyclerView.Adapter<FreeProductsAdapter.MyViewHolder>{

    private     List<DATAItem> dataItemList;
    private Context context;
    private FragmentActivity fragmentActivity;
    FreeProductAddToCart freeProductAddToCart;


    public FreeProductsAdapter(List<DATAItem> singleproductsItemList, Context context) {
        this.context=context;
        dataItemList=singleproductsItemList;
        fragmentActivity= (FragmentActivity) context;
        freeProductAddToCart= (FreeProductAddToCart) context;
    }
           ...
           // holder.AddButton.setOnClickListener(v -> callProductDetailsActivity(ProductItem));
            holder.AddButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    holder.AddButton.setEnabled(false);
                    freeProductAddToCart.freeProductAddToCart(ProductItem.getCID(),ProductItem.getPID(),ProductItem.getQUANTITY());
    ...
    public interface FreeProductAddToCart{
        void freeProductAddToCart(int cid, int pid, int q);
    }
}
