...
public class SquareMiniRecyclerViewAdapter extends RecyclerView.Adapter<SquareMiniRecyclerViewAdapter.MyViewHolder> {
    ...
    Context context;
    List<COINSEARNABLEPRODUCTSItem> coinsearnableproductsItemList;
    DynaMIcLink dynaMIcLink;

    public SquareMiniRecyclerViewAdapter(Context context, List<COINSEARNABLEPRODUCTSItem> coinsearnableproductsItemList,DynaMIcLink dynaMIcLink) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        COINSEARNABLEPRODUCTSItem coinsearnableproductsItem=coinsearnableproductsItemList.get(position);
