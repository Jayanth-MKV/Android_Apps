...
public class MiniFoodsRecyclerViewAdapter extends RecyclerView.Adapter<MiniFoodsRecyclerViewAdapter.MyViewHolder> {

    private List<FOODSItem> foodsItemList;
    private Context context;
    private FragmentActivity fragmentActivity;


    public MiniFoodsRecyclerViewAdapter(List<FOODSItem> foodsItemList, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        final FOODSItem ProductItem=foodsItemList.get(position);
    ...
    private void callProductDetailsActivity(FOODSItem ProductItem) {
