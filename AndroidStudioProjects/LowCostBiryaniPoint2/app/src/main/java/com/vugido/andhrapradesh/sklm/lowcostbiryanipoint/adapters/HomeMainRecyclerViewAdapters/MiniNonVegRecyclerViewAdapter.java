...
public class MiniNonVegRecyclerViewAdapter extends RecyclerView.Adapter<MiniNonVegRecyclerViewAdapter.MyViewHolder> {

    private List<NONVEGItem> nonvegItemList;
    private Context context;
    private FragmentActivity fragmentActivity;

    public MiniNonVegRecyclerViewAdapter(List<NONVEGItem> nonvegItemList, Context context) {
        this.nonvegItemList = nonvegItemList;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final NONVEGItem ProductItem=nonvegItemList.get(position);
    ...
    private void callProductDetailsActivity(NONVEGItem ProductItem) {
