...
public class MiniTiffins extends RecyclerView.Adapter<MiniTiffins.MyViewHolder> {

    private List<SNACKSItem> foodsItemList;
    private Context context;
    private FragmentActivity fragmentActivity;


    public MiniTiffins(List<SNACKSItem> foodsItemList, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        final SNACKSItem ProductItem=foodsItemList.get(position);
...
*/
    ...
    private void callProductDetailsActivity(SNACKSItem ProductItem) {
