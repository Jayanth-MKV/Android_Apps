...
public class MiniDryFruits extends RecyclerView.Adapter<MiniDryFruits.MyViewHolder> {

    private List<DRYFRUITSItem> foodsItemList;
    private Context context;
    private FragmentActivity fragmentActivity;


    public MiniDryFruits(List<DRYFRUITSItem> foodsItemList, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        final DRYFRUITSItem ProductItem=foodsItemList.get(position);
    ...
    private void callProductDetailsActivity(DRYFRUITSItem ProductItem) {
