...
public class MiniFruitsRecyclerViewAdapter extends RecyclerView.Adapter<MiniFruitsRecyclerViewAdapter.MyViewHolder> {


  private List<FRUITSItem> fruitsItemList;
  private Context context;
    private FragmentActivity fragmentActivity;


    public MiniFruitsRecyclerViewAdapter(List<FRUITSItem> fruitsItemList, Context context) {
        this.fruitsItemList = fruitsItemList;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        final FRUITSItem ProductItem=fruitsItemList.get(position);
    ...
    private void callProductDetailsActivity(FRUITSItem ProductItem) {
