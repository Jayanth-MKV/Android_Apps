...
public class MiniDairy extends RecyclerView.Adapter<MiniDairy.MyViewHolder> {

    private List<DAIRYPRODUCTSItem> foodsItemList;
    private Context context;
    private FragmentActivity fragmentActivity;

    public MiniDairy(List<DAIRYPRODUCTSItem> foodsItemList, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        final DAIRYPRODUCTSItem ProductItem=foodsItemList.get(position);
    ...
    private void callProductDetailsActivity(DAIRYPRODUCTSItem ProductItem) {
