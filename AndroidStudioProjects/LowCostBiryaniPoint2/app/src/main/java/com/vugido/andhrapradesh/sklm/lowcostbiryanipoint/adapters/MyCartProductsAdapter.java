...
public class MyCartProductsAdapter extends RecyclerView.Adapter<MyCartProductsAdapter.MyViewHolder> {
    ...
    private List<com.foodhub.vugido.models.updated.cart.FetchCart.DATAItem> cartProductModelList;
    private Context context;
    private CartDelete cartDelete;
    public MyCartProductsAdapter(List<com.foodhub.vugido.models.updated.cart.FetchCart.DATAItem> cartProductModelList, Context context){
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        if(ProductItem.getOFFERSTATUS()==1){
            ...
            // offer exists..
            holder.ProductPrice.setText(String.format(Locale.getDefault(),"Rs.%d/-", BaseProduct.offerPercentagePrice(ProductItem.getOFFER(), getQuantityPrice(ProductItem.getPRICE(),ProductItem), ProductItem.getOFFERLIMIT())));
            holder.StrikedPrice.setText(String.format(Locale.getDefault(),"Rs.%d/-", getQuantityPrice(ProductItem.getPRICE(),ProductItem)));

            holder.ProductDescription.setText(String.format(Locale.getDefault(),"%s (%d%% upto Rs.%d)", ProductItem.getDESCRIPTION(), ProductItem.getOFFER(), ProductItem.getOFFERLIMIT()));
            ...
            holder.ProductPrice.setText(String.format(Locale.getDefault(),"Rs.%d/-", getQuantityPrice(ProductItem.getPRICE(),ProductItem)));
        ...
        if(ProductItem.getISGRAMSET()==1){
            ...
            holder.ProductQuantity.setText(getGramQuantity(ProductItem.getCARTQUANTITY(),ProductItem.getDESCRIPTION()));
       ...
       if(ProductItem.getINSTOCK()==1){
        ...
        holder.ProductDeleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cartDelete.cartDelete(ProductItem.getCARTID());
