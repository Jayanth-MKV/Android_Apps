...
//    private List<RectangularMediumViewModel> rectangularMediumViewModelList;
    private List<ServiceCategoryProducts> squareMediumModelList;

    public List<ServiceCategoroesModel> getCategoriesItemList() {
        return categoriesItemList;
    }

    public void setCategoriesItemList(List<ServiceCategoroesModel> categoriesItemList) {
        this.categoriesItemList = categoriesItemList;
    }

    private List<ServiceCategoroesModel> categoriesItemList;
...
//        return homePageMainModel;
//    }
    public static HomePageMainModel createSquareMediumViewModelList(List<ServiceCategoroesModel> categoriesItemList,int type, List<ServiceCategoryProducts> squareMediumModelList, String title, int hid, String BG_COLOR, String TITLE_COLOR){
        HomePageMainModel homePageMainModel=new HomePageMainModel();
...
//    }
    ...
    public List<ServiceCategoryProducts> getSquareMediumModelList() {
        return squareMediumModelList;
    }

    public void setSquareMediumModelList(List<ServiceCategoryProducts> squareMediumModelList) {
