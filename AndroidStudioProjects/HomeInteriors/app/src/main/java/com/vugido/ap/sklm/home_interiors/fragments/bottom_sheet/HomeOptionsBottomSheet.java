package com.vugido.ap.sklm.home_interiors.fragments.bottom_sheet;
...
import com.vugido.ap.sklm.home_interiors.activities.TermsAndConditionsPrivacyPolicy;
import com.vugido.ap.sklm.home_interiors.adapters.homepage.HomeMenuBottomSheetAdapter;
import com.vugido.ap.sklm.home_interiors.app_config.MyPreferences;
import com.vugido.ap.sklm.home_interiors.models.BOTTOM_HOME_MODEL.HomeMenuBottomModel;
...
public class HomeOptionsBottomSheet extends BottomSheetDialogFragment implements View.OnClickListener, HomeMenuBottomSheetAdapter.OPTION_SELECTED {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        homeMenuBottomModelList.add(new HomeMenuBottomModel(R.drawable.history,"Previous Activity",2));
        ...
        homeMenuBottomModelList.add(new HomeMenuBottomModel(R.drawable.about_us,"About Us",9));
    ...
    public void optionSelected(int id) {
        ...
        switch (id){
            ...
            case 3:
                //whatsapp us
                try {
                    String text = "Dear Home Interiors  Team:\n";// Replace with your message.
            ...
            case 5:
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "\nInstall App Home Interiors\n");
                intent.putExtra(Intent.EXTRA_TEXT, "\nInstall App Home Interiors \nOne Stop For All Your Home Services\nClick On Link To Install" + "\n\n" + "http://play.google.com/store/apps/details?id=" + context.getPackageName());
