...
import com.vugido.info.homeservicesadmin.design.Space;
import com.vugido.info.homeservicesadmin.models.homepage.HomePageMainModel;

import java.util.List;

import static com.vugido.info.homeservicesadmin.models.homepage.HomePageMainModel.SQUARE_MEDIUM_VIEW;
...
//            CircularRecycledViewPool,ChipPool,MediumRectPool,SquareMiniPool,ListPool;
    ...
    public HomePageMainAdapter(List<HomePageMainModel> homePageMainModelList, Context context,int v) {
...
//                return new MySliderView(view);
            case SQUARE_MEDIUM_VIEW:
                ...
                mySquareMedium.SquareMediumRecyclerView.addItemDecoration(new Space(3,10,false,0));
...
//                });
               ...
               // ((MySquareMedium)holder).SquareMediumRecyclerView.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.VERTICAL,false));
                ...
                ((MySquareMedium)holder).SquareMediumRecyclerView.addItemDecoration(new Space(3,5,true,0));
                SquareMediumRecyclerViewAdapter squareMediumRecyclerViewAdapter=new SquareMediumRecyclerViewAdapter(homePageMainModel.getSquareMediumModelList(),context,homePageMainModel.getCategoriesItemList(),v);
