...
import static com.vugido.info.homeservicesadmin.models.near_page.NearPageMainModel.SQUARE_MEDIUM_VIEW;
...
//            CircularRecycledViewPool,ChipPool,MediumRectPool,SquareMiniPool,ListPool;
    ...
    public NearPageMainAdapter(List<NearPageMainModel> homePageMainModelList, Context context,int v) {
...
//                });
               ...
               // ((MySquareMedium)holder).SquareMediumRecyclerView.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.VERTICAL,false));
                ...
                NearMediumRecyclerViewAdapter squareMediumRecyclerViewAdapter=new NearMediumRecyclerViewAdapter(homePageMainModel.getSquareMediumModelList(),context,homePageMainModel.getCategoriesItemList(),v);
