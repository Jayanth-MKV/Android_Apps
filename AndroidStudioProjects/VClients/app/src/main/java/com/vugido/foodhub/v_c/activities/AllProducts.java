...
import com.vugido.foodhub.v_c.adapter.inventory.AllProductsRecyclerViewAdapter;
...
import com.vugido.foodhub.v_c.models.all_products.Response;
...
public class AllProducts extends AppCompatActivity implements AllProductsRecyclerViewAdapter.Updater , SearchView.OnQueryTextListener {
...
//        toolbar_title.setText("All Products");
    ...
    private void initDelete(final int pid) {
        ...
        Call<com.vugido.foodhub.v_c.models.error.Response> call=RetrofitBuilder.getInstance().getRetrofit().delete(map);

        call.enqueue(new Callback<com.vugido.foodhub.v_c.models.error.Response>() {
            @Override
            public void onResponse(@NonNull Call<com.vugido.foodhub.v_c.models.error.Response> call, @NonNull retrofit2.Response<com.vugido.foodhub.v_c.models.error.Response> response) {
                progress.setVisibility(View.GONE);
                progress.cancelAnimation();
                if(response.isSuccessful()){
            ...
            @Override
            public void onFailure(@NonNull Call<com.vugido.foodhub.v_c.models.error.Response> call, @NonNull Throwable t) {
                progress.setVisibility(View.GONE);
                progress.cancelAnimation();
                showDialogStatus(false,"Deleted Successfully","Error!! Try Again..");
            }
...
*/
    ...
    public boolean onQueryTextChange(String newText) {
        Log.e("called",newText );
        Toast.makeText(this,newText,Toast.LENGTH_LONG).show();

        if(allProductsRecyclerViewAdapter!=null)
            allProductsRecyclerViewAdapter.getFilter().filter(newText);
        return true;
    }
}
